 ...
 * LCD CONTROL PINS
 * ________________________________________________________*/
#define LCD_RS_PIN  			DIO_PORTC , DIO_PIN_1   /*Register Select Pin (Command or Data) (Port No , Pin No)*/
#define LCD_RW_PIN  			DIO_PORTC , DIO_PIN_2   /*Read Write Pin (Read or Write) (Port No , Pin No)*/
#define LCD_E_PIN  				DIO_PORTC , DIO_PIN_3   /*Enable Pin (Port No , Pin No)*/
